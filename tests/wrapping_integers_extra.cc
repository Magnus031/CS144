...
{
  try {
    for ( uint64_t checkpoint = 0; checkpoint < 10000; ++checkpoint ) {
    ...
    for ( uint64_t checkpoint = UINT32_MAX - 100000UL; checkpoint < UINT32_MAX + 10000UL; ++checkpoint ) {
    ...
    for ( uint64_t checkpoint = 2UL * UINT32_MAX - 100000UL; checkpoint < 2UL * UINT32_MAX + 10000UL;
          ++checkpoint ) {
