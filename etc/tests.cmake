...
add_custom_target (check2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 24 -R '^byte_stream_|^reassembler_|^wrapping|^recv')

add_custom_target (check3 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 24 -R '^byte_stream_|^reassembler_|^wrapping|^recv|^send')
